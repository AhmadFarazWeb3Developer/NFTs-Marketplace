...
// //     return (
// //       <div
// //         className="flex flex-col font-light gap-3 p-5 w-fit bg-[rgba(255,255,255,0.05)]
...
// //         <div className="text-sm text-[var(--color-paragraph)]">
...
// //         <div key={index} className="text-sm break-all space-y-2">
// //           <div className="border-t border-[rgba(192,192,192,0.2)] my-1"></div>

// //           <div className="text-sm font-semibold text-[var(--color-action-btn-green)]">
// //             {evt.event} Event
// //           </div>
...
// //             <>
// //               <div>
// //                 From: <span className="text-white/90">{evt.from}</span>
// //               </div>
// //               <div>
// //                 To: <span className="text-white/90">{evt.to}</span>
// //               </div>
// //               <div>
// //                 Token ID: <span className="text-white/90">{evt.tokenId}</span>
// //               </div>
// //             </>
// //           )}
...
//           <div className="text-[var(--color-action-btn-green)] font-medium">
//             {evt.event} Event
//           </div>
